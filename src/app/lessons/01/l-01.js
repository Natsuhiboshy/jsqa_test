...
// Answer: Yes it is. The not executable code can be paste in comment.
console.log("Answer to question 1: Comments are not executable code. So the answer is Yes.");
// Task 01.02 - 2 points
// Question: How we can tell the JS interpreter to use strict mode?
// Answer: use constriction "use strict";
console.log("Answer to question 2: Use construction \"use strict;\".");
// Task 01.03 - 2 points
// Q: What simple data types are used in JS?
// A: The used data types are: Number, String, Boolian, Null, Undefived, Symbol.
console.log("Answer to question 3: The used simple data types are: Number, String, Boolian, Null, Undefived, Symbol.");
// Task 01.04 - 2 points
// Q: What complex data types are used in JS?
// A: The used complex data type is Object. The Array, function, date are also objects.
console.log("Answer to question 4: The used complex data type is Object. The Array, function, date are also objects.");
// Task 01.05 - 3 points
