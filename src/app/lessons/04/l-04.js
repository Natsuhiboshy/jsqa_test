...
var newArray = [21, 63, 84];
newArray.forEach (function (value, index, array){ array[index] = value+42; });
...
function arrayCleanUp(arrayToCleanUp) {
	...
	// TODO: пиши свій код тут:
	cleanedUp = cleanedUp.filter(function (el){return typeof(el)==='number';});
	return cleanedUp;
}
