...
(function () {
	...
	*/
	...
	// TODO: дай відповідь тут: перша оголошена фугкція func1 не є замиканням, оскільки взагалі нічого не повертає. Друга оголошена функція повертає функцію і може бути замиканням,
	// якщо функція func1InternalFunc буде надавати доступ до даних функції func1.
	...
	function sillyClosure(counterStart) {
		let internalCounter = counterStart;
		function countMe (){ 
			internalCounter++; 
	...
	var counter = sillyClosure(5);
	var srartCount = counter();
	...
	// TODO: пиши відповідь словами тут: Можна повернути значення за допомогою виразу 
	// return iAmEnclosed; або дописати функцію замикання, яку буде повертати функція iAmClosure, і 
	// вже ця функція матиме доступ до змінної iAmEnclosed
	...
	function clouserForTask4 (){
		var closerVariable = {
			lesson: 7,
			task: 4,
			text: 'write function that will return function with acces to the internal variable',
			resul: 'done'
		};
		function closedInside (){
			return closerVariable;
		}
		return closedInside;
	}
	console.log(clouserForTask4());
	console.log(clouserForTask4()());
